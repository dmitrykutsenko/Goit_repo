...
# Create an instance of the Vector class with coordinates (1, 10)
vector = Vector(Point(1, 10))

# Access the coordinates using square brackets
print(vector.coordinates.x)  # Output: 1
print(vector.coordinates.y)  # Output: 10

# Set the x coordinate of vector to 10 using square brackets
vector[0] = 10

# Access the updated x coordinate using square brackets
print(vector[0])  # Output: 10

# Access the y coordinate using square brackets
print(vector[1])  # Output: 10
