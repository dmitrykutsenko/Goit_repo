...
# Call the Vector instance without a parameter
print(vector())  # Output: (1, 10)

# Call the Vector instance with a parameter (perform vector multiplication)
print(vector(5))  # Output: (5, 50)
