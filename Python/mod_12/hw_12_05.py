'''
продовжимо розширювати приклад попереднього завдання. Додайте до класу Contacts атрибут count_save, 
...
'''
first = Contacts.read_from_file("user_class.dat")
second = Contacts.read_from_file("user_class.dat")
'''
